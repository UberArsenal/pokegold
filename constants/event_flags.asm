...
; Phone events
	...
	const EVENT_ELM_CALLED_ABOUT_SHINY_POKEMON
	const_skip ; unused
...
; Johto people
	...
	const EVENT_GOLDENROD_CLOTHING_SHOP_BOUGHT_BLUE
	const EVENT_GOLDENROD_CLOTHING_SHOP_BOUGHT_GREEN
	const EVENT_GOLDENROD_CLOTHING_SHOP_BOUGHT_PURPLE
	const EVENT_GOLDENROD_CLOTHING_SHOP_STYLIST_INTRO
	...
	const EVENT_TEAM_ROCKET_BASE_B2F_GRUNT_WITH_EXECUTIVE
        const EVENT_TEAM_ROCKET_BASE_B2F_FERALIGATR
...
; Unused: next 5 events
    const EVENT_NATIONAL_PARK_SHINY_HERACROSS
    const EVENT_NATIONAL_PARK_SHINY_HERACROSS_REWARD_READY
	const EVENT_ROUTE_36_SHINY_SUDOWOODO
	const EVENT_FOUGHT_SHINY_SUDOWOODO
	const EVENT_CHERRYGROVE_CITY_SHINY_OCTILLERY
; Kanto people
...
; Kanto itemballs
	...
	const EVENT_ROUTE_12_CALCIUM
        ...
        const EVENT_TEAM_ROCKET_BASE_B2F_SILVER
; Unused: next 115 events

    const_next 2048
DEF NUM_EVENTS EQU const_value ; 801
