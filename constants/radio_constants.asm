...
; internal indexes for channel segments
	...
	const POKEDEX_SHOW_6         ; 41
	const POKEDEX_SHOW_7         ; 42
	const POKEDEX_SHOW_8         ; 43
	const JOHTO_NEWS_RADIO_1     ; 44
	const JOHTO_NEWS_RADIO_2	 ; 45
	const JOHTO_NEWS_RADIO_3	 ; 46
	const JOHTO_NEWS_RADIO_4	 ; 47
...
; PlayRadioStationPointers indexes (see engine/pokegear/pokegear.asm)
	...
	const MAPRADIO_JOHTO_NEWS_RADIO
