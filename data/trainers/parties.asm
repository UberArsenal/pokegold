...
PryceGroup:
	...
	db 34, DEWGONG, NEVERMELTICE, HEADBUTT, ICY_WIND, AURORA_BEAM, REST
...
ClairGroup:
	...
	db 40, DRAGONAIR, MAGNET, THUNDER_WAVE, THUNDERBOLT, DRAGON_RAGE, DRAGONBREATH
	db 41, DRAGONAIR, NEVERMELTICE, THUNDER_WAVE, ICE_BEAM, SLAM, DRAGONBREATH
