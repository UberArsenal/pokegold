...
FalknerGroup:
	...
	db  10, NOCTOWL,  PECK, MUD_SLAP, CONFUSION, NO_MOVE
	db -1 ; end
...
JasmineGroup:
	...
	db 35, STEELIX, QUICK_ATTACK, SANDSTORM, EARTHQUAKE, ROCK_SLIDE, IRON_TAIL
...
ClairGroup:
	...
	db 37, DRAGONAIR, THUNDER_WAVE, SURF, DRAGON_RAGE, DRAGONBREATH
	db 37, DRAGONAIR, THUNDER_WAVE, THUNDERBOLT, DRAGON_RAGE, DRAGONBREATH
	db 37, DRAGONAIR, THUNDER_WAVE, ICE_BEAM, SLAM, DRAGONBREATH
	db 42, KINGDRA, DRAGON_FANG, SMOKESCREEN, HYDRO_PUMP, HYPER_BEAM, DRAGONBREATH
	db -1 ; end
