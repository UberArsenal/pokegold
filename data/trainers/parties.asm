...
FalknerGroup:
	...
	db  8, NATU, FURY_ATTACK, MUD_SLAP, CONFUSION, LEER
	db	8, HOOTHOOT, PECK, MUD_SLAP, FORESIGHT, NO_MOVE
	db  10, NOCTOWL, PECK, MUD_SLAP, CONFUSION, HYPNOSIS
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_ITEM_MOVES
	db 18, CLEFAIRY, NO_ITEM, DOUBLESLAP, ATTRACT, SING, METRONOME
	db 19, FURRET, NO_ITEM, HEADBUTT, AMNESIA, QUICK_ATTACK, BATON_PASS 
	db 20, MILTANK, NO_ITEM, ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end

BugsyGroup:
	; BUGSY (1)
	db "BUGSY@", TRAINERTYPE_ITEM_MOVES
	db 14, LEDIAN, SILVERPOWDER, COMET_PUNCH, SWIFT, LEECH_LIFE, PSYBEAM
	db 14, HERACROSS, SILVERPOWDER, HORN_ATTACK, PIN_MISSILE, ENDURE, FLAIL
	db 16, YANMA, SILVERPOWDER, SUPERSONIC, LEECH_LIFE, SONICBOOM, DOUBLE_TEAM
	db 16, SCYTHER,SILVERPOWDER, QUICK_ATTACK, FOCUS_ENERGY, FURY_CUTTER, PURSUIT
	db -1 ; end
...
MortyGroup:
	...
	db 23, HAUNTER, HYPNOSIS, MEAN_LOOK, CURSE, NIGHT_SHADE
	db 25, GENGAR, HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 26, MISDREAVUS, HYPNOSIS, NIGHTMARE, SHADOW_BALL, PAIN_SPLIT
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_ITEM_MOVES
	db 34, LAPRAS, NEVERMELTICE, BODY_SLAM, BLIZZARD, SURF, MIST
	db 36, DELIBIRD, BRIGHTPOWDER, HEADBUTT, AURORA_BEAM, PRESENT, BLIZZARD
	db 36, VAPOREON, MYSTIC_WATER, AURORA_BEAM, SURF, FLAIL, PROTECT
	db 37, SNEASEL, BLACKGLASSES, ICY_WIND, BEAT_UP, FRUSTRATION, DOUBLE_TEAM 
	db 38, JYNX, SCOPE_LENS, ICE_BEAM, PSYCHIC_M, LOVELY_KISS, FUTURE_SIGHT
	db 39, PILOSWINE, QUICK_CLAW, ICE_BEAM, EARTHQUAKE, PROTECT, BLIZZARD
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_ITEM_MOVES
	db 33, FORRETRESS, FOCUS_BAND, SPIKES, PROTECT, PIN_MISSILE, EXPLOSION
	db 33, MAGNETON, MAGNET, THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 35, SKARMORY, METAL_COAT, STEEL_WING, DRILL_PECK, SAND_ATTACK, AGILITY
	db 35, STEELIX, QUICK_CLAW, SANDSTORM, EARTHQUAKE, ROCK_SLIDE, IRON_TAIL
	db 36, SCIZOR, METAL_COAT, AGILITY, SWORDS_DANCE, METAL_CLAW, REVERSAL
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 27, PRIMEAPE, QUICK_CLAW, SEISMIC_TOSS, FOCUS_ENERGY, KARATE_CHOP, FURY_SWIPES
	db 28, HITMONLEE, BLACKBELT_I, HI_JUMP_KICK, MIND_READER, DETECT, ROLLING_KICK
	db 28, HITMONCHAN, SCOPE_LENS, THUNDERPUNCH, DETECT, DYNAMICPUNCH, MEGA_PUNCH
	db 30, HITMONTOP, BLACKBELT_I, TRIPLE_KICK, COUNTER, ROLLING_KICK, DETECT
	db 30, MACHAMP, BLACKBELT_I, VITAL_THROW, REVERSAL, DYNAMICPUNCH, THUNDERPUNCH
	db 33, POLIWRATH, MYSTIC_WATER, HYPNOSIS, MIND_READER, HYDRO_PUMP, DYNAMICPUNCH	
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_ITEM_MOVES
	db 40, GYARADOS, NO_ITEM, WATERFALL, THRASH, TWISTER, CRUNCH
	db 40, DRAGONAIR, MYSTIC_WATER, THUNDER_WAVE, SURF, DRAGON_RAGE, DRAGONBREATH
	db 40, DRAGONAIR, MAGNET, SAFEGUARD, THUNDERBOLT, DRAGON_RAGE, DRAGONBREATH
	db 41, DRAGONAIR, NEVERMELTICE, SAFEGUARD, ICE_BEAM, DRAGON_RAGE, DRAGONBREATH
	db 44, KINGDRA, DRAGON_FANG, SMOKESCREEN, HYDRO_PUMP, HYPER_BEAM, DRAGONBREATH
	db -1 ; end
...
ChampionGroup:
	...
	db 47, YANMA, DRAGON_RAGE, TWISTER, THUNDER, HYPER_BEAM
...
BrockGroup:
	...
	db 55, RHYHORN,    FURY_ATTACK, SCARY_FACE, EARTHQUAKE, HORN_DRILL
	db 55, OMASTAR,    BITE, SURF, PROTECT, SPIKE_CANNON
	db 55, STEELIX,    EARTHQUAKE, ROCK_SLIDE, BIDE, SANDSTORM
...
CooltrainerFGroup:
	...
	db 25, JUMPLUFF,   SYNTHESIS, POISONPOWDER, MEGA_DRAIN, LEECH_SEED
...
BeautyGroup:
	...
	db 17, SKIPLOOM,     SYNTHESIS, TAIL_WHIP, TACKLE, POISONPOWDER
...
BugCatcherGroup:
	...
	db 30, VENOMOTH,   SLEEP_POWDER, SUPERSONIC, PSYBEAM, LEECH_LIFE
	db -1 ; end
...
Rival2Group:
	; RIVAL2 (1)
	db "?@", TRAINERTYPE_MOVES
	db 41, SNEASEL,    FRUSTRATION, SCREECH, FAINT_ATTACK, SLASH
	db 42, GOLBAT,     LEECH_LIFE, BITE, CONFUSE_RAY, WING_ATTACK
	db 41, MAGNETON,   THUNDER, SONICBOOM, THUNDER_WAVE, LOCK_ON
	db 43, GENGAR,     HYPNOSIS, NIGHTMARE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   HYPNOSIS, RECOVER, REFLECT, PSYCHIC_M
	db 45, MEGANIUM,   GIGA_DRAIN, POISONPOWDER, BODY_SLAM, LIGHT_SCREEN
	db -1 ; end
	...
	db 43, GENGAR,     HYPNOSIS, NIGHTMARE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   HYPNOSIS, RECOVER, REFLECT, PSYCHIC_M
	db 45, TYPHLOSION, SMOKESCREEN, FIRE_PUNCH, FLAMETHROWER, EARTHQUAKE
	db -1 ; end
	...
	db 45, FERALIGATR, DRAGON_RAGE, SURF, SCARY_FACE, SLASH
	db -1 ; end

	; RIVAL2 (4)
	db "?@", TRAINERTYPE_MOVES
	db 45, SNEASEL,    BEAT_UP, SCREECH, FRUSTRATION, FURY_CUTTER
	db 48, CROBAT,     TOXIC, CRUNCH, CONFUSE_RAY, FLY
