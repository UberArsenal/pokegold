...
MapGroup_Olivine:
	...
	map Route40SafariZoneGateF1, TILESET_GATE, GATE, LANDMARK_ROUTE_40, MUSIC_ROUTE_36, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Dungeons:
	...
	map JohtoSafariZone, TILESET_PARK, CAVE, LANDMARK_NATIONAL_PARK, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
